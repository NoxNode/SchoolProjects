...
namespace IFs {
	...
	void THREAD_BEGIN(Instruction* instruction);
	void THREAD_END(Instruction* instruction);
	void LOCK(Instruction* instruction);
	void UNLOCK(Instruction* instruction);
	void BARRIER(Instruction* instruction);
}
