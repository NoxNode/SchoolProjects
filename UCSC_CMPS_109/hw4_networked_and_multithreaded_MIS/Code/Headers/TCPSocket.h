...
public:
	...
	// we changed timeoutMilli to timeoutMicro because the man pages for select says tv_usec is in micro-seconds not millis
	int readFromSocketWithTimeout (char * buffer, int maxBytes, long timeoutSec, long timeoutMicro);
