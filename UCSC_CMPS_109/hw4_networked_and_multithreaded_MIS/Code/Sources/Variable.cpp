...
template <typename T>
Variable<T>::Variable(char p_type, T p_value, bool p_isConstant) :
value(p_value)
{
...
// defining each version of this function (necessary if we're separating definition from declaration)
template Variable<NUMERIC>::Variable(char p_type, NUMERIC p_value, bool p_isConstant);
template Variable<REAL>::Variable(char p_type, REAL p_value, bool p_isConstant);
template Variable<CHAR>::Variable(char p_type, CHAR p_value, bool p_isConstant);
template Variable<STRING>::Variable(char p_type, STRING p_value, bool p_isConstant);
